...
def syorganization_treeGrid():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, "data": [org.to_json() for org in orgs]})
...
def syorganization_tree_select():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, "data": [org.to_tree_select_json() for org in orgs]}) 
...
def syorganization_getById(id):
    ...
    if org:
        return jsonify({'msg': 'operation success', 'code': 200, 'data': org.to_json()})
    else:
