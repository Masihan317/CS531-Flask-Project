...
def cancel_all_role():
    ...
    return jsonify({'code': 200, 'msg': 'cancel success'})
...
def syrole_getById(id):
    ...
    if role:
        return jsonify({'code': 200, 'msg': 'operation success', 'data': role.to_json()})
    else:
...
def roleDeptTreeselect(id):
    ...
    return jsonify({'code': 200, 'msg': 'operation success', 'checkedKeys': [dept.ID for dept in role.depts], \
