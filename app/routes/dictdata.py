...
def sysdictdata_get_by_type(dictType):
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'data': [data.to_json() for data in data_list]})
...
def sysdict_data_list():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'rows': [data.to_json() for data in data_list], 'total': pagination.total})
...
def sysdict_data_get_by_id(id):
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'data': data.to_json()})
