...
def syresource_treeGrid():
    ...
    return jsonify({"msg":"operation success","code":200, "data": [org.to_json() for org in res_list]})
...
def syresource_getById(id):
    ...
    if res:
        return jsonify({'code': 200, 'msg': 'operation success', 'data': res.to_json()})
    else:
...
def syresource_tree_select():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, "data": [res.to_tree_select_json() for res in resList]})
