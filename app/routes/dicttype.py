...
def sysdict_type_list():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'rows': [type.to_json() for type in types], 'total': pagination.total})
...
def sysdict_type_get_by_id(id):
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'data': type.to_json()})
...
def sysdict_type_all():
    ...
    return jsonify({'msg': 'operation success', 'code': 200, 'data': [type.to_json() for type in types]})   
